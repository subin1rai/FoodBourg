...
const LoginPage = () => {
 ...
 <div className='w-screen h-screen flex flex-col '>
   ...
   <div className='flex items-center h-[90vh] justify-between px-8 w-screen gap-3 '> 
    ...
    <div className='flex w-[40%] flex-col border-2 justify-center gap-6'>
      <div className='flex flex-col items-center gap-1 pt-8 mb-4 '>
        <h1 className='text-3xl font-medium'>Welcome Back</h1>
        <p className='text-sm text-neutral-400'>Once you try it,you will love it</p>
      </div>

      <form action="" className='flex flex-col px-12  gap-2'>
       <div className='flex flex-col gap-2'>
       <label htmlFor="" className='text-[18px] '>Email</label>
       <input type="text" className='py-3 border-2 border-neutral-400 focus:border-red-400 px-4 rounded ' />
       </div>
       <div className='flex flex-col gap-2'>
       <label htmlFor="" >Password</label>
       <input type="text" className='py-3 border-2 px-4 border-neutral-400 rounded ' />
       </div>

       <button className='w-full bg-red-500 py-3 mt-5 rounded text-white text-xl '>Log In</button>
      ...
      <p>Not a User? <span className='text-red-500'>Register</span></p>
      </div>
